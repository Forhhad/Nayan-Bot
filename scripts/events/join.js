...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage কিরে খানকির পলারা ৬ তানি করতে অ্যাড দিলি নাকি😈🦅!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
🟣Facebook Account Link: https://www.facebook.com/profile.php?id=100082724958871

🔵WHATSAPP NUMBER: fuck654

🟢SUPPORT EMAIL: myzone411@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
